...
class World (object):
  ...
  def __init__ (self):
    ...
    elif sim.config.remote_interface == "web":
      import sim.comm_web as interface
    else:
      ...
      while self._running:
        ...
        if self.trace:
          if hasattr(o[2], "__self__"):
            print(o[2].__self__.__class__.__name__ + "." + o[2].__func__.__name__,end='')
          else:
            print(o[2],end='')
